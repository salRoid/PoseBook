...
disagree about something suite-wide, `Lumen/DECISIONS.md` wins.

@AGENTS.md

**Half-done, unverified or deferred work is in `NEXT.md`** (imported below) —
read it before starting, and delete a line the moment it is finished.
